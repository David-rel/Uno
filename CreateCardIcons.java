...
public class CreateCardIcons {
    ...
    static ImageIcon GREEN_1_2 = new ImageIcon("pics/Green1.png");
    static ImageIcon GREEN_2_2 = new ImageIcon("pics/Green2.png");
    static ImageIcon GREEN_3_2 = new ImageIcon("pics/Green3.png");
    static ImageIcon GREEN_4_2 = new ImageIcon("pics/Green4.png");
    static ImageIcon GREEN_5_2 = new ImageIcon("pics/Green5.png");
    static ImageIcon GREEN_6_2 = new ImageIcon("pics/Green6.png");
    static ImageIcon GREEN_7_2 = new ImageIcon("pics/Green7.png");
    static ImageIcon GREEN_8_2 = new ImageIcon("pics/Green8.png");
    static ImageIcon GREEN_9_2 = new ImageIcon("pics/Green9.png");
    static ImageIcon GREEN_SKIP_2 = new ImageIcon("pics/GreenSkip.png");
    static ImageIcon GREEN_REVERSE_2 = new ImageIcon("pics/GreenReverse.png");
    static ImageIcon GREEN_DRAW_2_2= new ImageIcon("pics/GreenPlusTwo.png");
    ...
    static ImageIcon RED_1_2 = new ImageIcon("pics/Red1.png");
    static ImageIcon RED_2_2 = new ImageIcon("pics/Red2.png");
    static ImageIcon RED_3_2 = new ImageIcon("pics/Red3.png");
    static ImageIcon RED_4_2 = new ImageIcon("pics/Red4.png");
    ...
    static ImageIcon RED_DRAW_2_2= new ImageIcon("pics/RedPlusTwo.png");
    ...
    static ImageIcon BLUE_1_2 = new ImageIcon("pics/Blue1.png");
    static ImageIcon BLUE_2_2 = new ImageIcon("pics/Blue2.png");
    static ImageIcon BLUE_3_2 = new ImageIcon("pics/Blue3.png");
    static ImageIcon BLUE_4_2 = new ImageIcon("pics/Blue4.png");
    static ImageIcon BLUE_5_2 = new ImageIcon("pics/Blue5.png");
    static ImageIcon BLUE_6_2 = new ImageIcon("pics/Blue6.png");
    static ImageIcon BLUE_7_2 = new ImageIcon("pics/Blue7.png");
    static ImageIcon BLUE_8_2 = new ImageIcon("pics/Blue8.png");
    static ImageIcon BLUE_9_2 = new ImageIcon("pics/Blue9.png");
    static ImageIcon BLUE_SKIP_2 = new ImageIcon("pics/BlueSkip.png");
    static ImageIcon BLUE_REVERSE_2 = new ImageIcon("pics/BlueReverse.png");
    static ImageIcon BLUE_DRAW_2_2= new ImageIcon("pics/BluePlusTwo.png");
    ...
    static ImageIcon YELLOW_1_2 = new ImageIcon("pics/Yellow1.png");
    static ImageIcon YELLOW_2_2 = new ImageIcon("pics/Yellow2.png");
    static ImageIcon YELLOW_3_2 = new ImageIcon("pics/Yellow3.png");
    static ImageIcon YELLOW_4_2 = new ImageIcon("pics/Yellow4.png");
    static ImageIcon YELLOW_5_2 = new ImageIcon("pics/Yellow5.png");
    static ImageIcon YELLOW_6_2 = new ImageIcon("pics/Yellow6.png");
    static ImageIcon YELLOW_7_2 = new ImageIcon("pics/Yellow7.png");
    static ImageIcon YELLOW_8_2 = new ImageIcon("pics/Yellow8.png");
    static ImageIcon YELLOW_9_2 = new ImageIcon("pics/Yellow9.png");
    static ImageIcon YELLOW_SKIP_2 = new ImageIcon("pics/YellowSkip.png");
    static ImageIcon YELLOW_REVERSE_2 = new ImageIcon("pics/YellowReverse.png");
    static ImageIcon YELLOW_DRAW_2_2 = new ImageIcon("pics/YellowPlusTwo.png");


    static ImageIcon WILD_PLUS_4_1 = new ImageIcon("pics/PlusFour.png");
    static ImageIcon WILD_PLUS_4_2 = new ImageIcon("pics/PlusFour.png");
    static ImageIcon WILD_PLUS_4_3 = new ImageIcon("pics/PlusFour.png");
    static ImageIcon WILD_PLUS_4_4 = new ImageIcon("pics/PlusFour.png");
    static ImageIcon WILD_1 = new ImageIcon("pics/Wild.png");
    static ImageIcon WILD_2 = new ImageIcon("pics/Wild.png");
    static ImageIcon WILD_3 = new ImageIcon("pics/Wild.png");
    static ImageIcon WILD_4 = new ImageIcon("pics/Wild.png");
    ...
    public static ImageIcon[] Create(){
        ...
        ImageIcon[] listOfCardIcons = {RED_0, RED_1, RED_2, RED_3, RED_4, RED_5, RED_6, RED_7, RED_8, RED_9, RED_SKIP, RED_REVERSE, RED_DRAW_2,
                                    ...
                                    WILD_1, WILD_PLUS_4_1, 
                                    RED_1_2, RED_2_2, RED_3_2, RED_4_2, RED_5_2, RED_6_2, RED_7_2, RED_8_2, RED_9_2, RED_SKIP_2, RED_REVERSE_2, RED_DRAW_2_2,
                                    RED_1_2, BLUE_2_2, BLUE_3_2, BLUE_4_2, BLUE_5_2, BLUE_6_2, BLUE_7_2, BLUE_8_2, BLUE_9_2, BLUE_SKIP_2, BLUE_REVERSE_2, BLUE_DRAW_2_2,
                                    GREEN_1_2, GREEN_2_2, GREEN_3_2, GREEN_4_2, GREEN_5_2, GREEN_6_2, GREEN_7_2, GREEN_8_2, GREEN_9_2, GREEN_SKIP_2, GREEN_REVERSE_2, GREEN_DRAW_2_2,
                                    YELLOW_1_2, YELLOW_2_2, YELLOW_3_2, YELLOW_4_2, YELLOW_5_2, YELLOW_6_2, YELLOW_7_2, YELLOW_8_2, YELLOW_9_2, YELLOW_SKIP_2, YELLOW_REVERSE_2, YELLOW_DRAW_2_2,
                                    WILD_2, WILD_3, WILD_4, WILD_PLUS_4_2, WILD_PLUS_4_3, WILD_PLUS_4_4
                                    };
