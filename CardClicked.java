    ...
    public class CardClicked {
        public static JButton Check(JButton[] ListOfCards, ArrayList<String> PlayerHand, int PlayerHandLength, ArrayList<Integer> PlayerHandIndex, int i){
		
        
            if (PlayerHand.get(i).contains("(1)") || PlayerHand.get(i).contains("0")) {
                if (PlayerHand.get(i).charAt(0) == 'R'){
                    switch(PlayerHand.get(i).charAt(1)){
                        case '0':
                ...
                else if (PlayerHand.get(i).charAt(0) == 'B'){
                    switch(PlayerHand.get(i).charAt(1)) {
                        case '0':
                ...
                else if (PlayerHand.get(i).charAt(0) == 'G'){
                    switch(PlayerHand.get(i).charAt(1)){
                        case '0':
                ...
                else if (PlayerHand.get(i).charAt(0) == 'Y'){
                    switch(PlayerHand.get(i).charAt(1)){
                        case '0':
            ...
            else if (PlayerHand.get(i).contains("(2)")) {
                if (PlayerHand.get(i).charAt(0) == 'R'){
                    switch(PlayerHand.get(i).charAt(1)){
                        case '1':
            ...
            else if (PlayerHand.get(i).contains("(3)")) {
                switch(PlayerHand.get(i).charAt(1)){
                        case '(':
            ...
            else if (PlayerHand.get(i).contains("(4)")) {
                switch(PlayerHand.get(i).charAt(1)){
                        case '(':
